...
public class XMLReader {
	...
	private static final String CLOSING_DOC_ERROR_MSG = "[!] Error while closing the document [!]";
	private static final String CLOSING_READER_ERROR_MSG = "[!] Error while closing the reader [!]";
	 ...
	 * </p>
	 * 
	 * @param inputFile Nome del file .xml che si desidera leggere
	 */
	...
	/**
	 * Metodo per leggere <b>l'intero</b> file xml e stampare a video tutti gli elementi.
	 * <p>
	...
	/**
	 * Metodo per chiudere il lettore passato come parametro implicito.
	 * @return true se l'operazione di chiusura non riscontra problemi, false altrimenti.
	 */
	public boolean closeReader() {
		try {
			...
			System.out.println(CLOSING_READER_ERROR_MSG);
			e.printStackTrace();
			return false;
		}
	}
	...
	public String readNext() {
		...
		return s == null ? this.readNext() : s;  // Prima di restituire la stringa s, verifica che non sia null.
												 // Puo' capitare che la stringa sia null se, per esempio, il file xml contiene spazi vuoti (che vengono 	
												 // letti come evento CHARACTERS e che il metodo handleCHARACTERS interpreta come stringa null)
	...
	private String handleEND_ELEMENT() {
		String s = String.format("End-Tag : %s", xmlr.getLocalName());
		return s;
	}
	...
	private String handleCHARACTERS() {
		String s = String.format("Content of Tag : %s", xmlr.getText());
